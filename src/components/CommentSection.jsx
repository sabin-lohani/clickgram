...
export default function CommentSection({ id }) {
  ...
  return (
    <div>
      {comments.length > 0 && (
        <div className="mx-10 max-h-24 p-2 overflow-y-scroll">
          {comments.map((comment, idx) => (
            ...
            >
              ...
              <Moment fromNow className="text-xs text-gray-500 pr-2">
      ...
      {session && (
        <form onSubmit={handleSubmit} className="flex items-center  p-4 gap-2">
          ...
          <button
            ...
            type="submit"
            className="font-semibold text-blue-400 disabled:invisible"
          >
            Post
          </button>
        </form>
